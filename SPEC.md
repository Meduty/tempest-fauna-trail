...
- D.28 Combat-view polish — **DEFERRED (post-MVP).** The combat view (T.12/T.12c) is
  ...
  **[2026-06-27, B.35] Partially mitigated:** the sub-frame FX-flash is patched by a
  ...
  damage numbers paint; the full timeline/scheduler rework is still deferred. (2) The
