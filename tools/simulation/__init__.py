...
Exhaustive deterministic matchup sweeps + win-rate ratings derived from
...
Sub-modules:
    ...
    ratings     — deterministic power-threshold expected WR + binary win rate (per-piece attribution)
