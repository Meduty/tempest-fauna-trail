...
_CHAMPION_DEFS: tuple[ChampionDef, ...] = (
    ...
    _champion_def("champ_grovekeeper_tapir", "Grovekeeper Tapir", WeatherState.RAIN, 4, "melee", ["Tidekin", "Bruiser", "Mender"], durability="tanky_arm", playstyle="auto", speed="leaden"),
    _champion_def("champ_coral_colossus", "Coral Colossus", WeatherState.RAIN, 5, "melee", ["Tidekin", "Guardian", "Mender"], stat="str", durability="tanky_hp", playstyle="auto", intent="utility", speed="leaden"),
    ...
    _champion_def("champ_mirewarden_toad", "Mirewarden Toad", WeatherState.RAIN, 7, "melee", ["Tidekin", "Guardian"], stat="int", durability="tanky_hp", playstyle="auto", intent="utility", speed="leaden"),
    _champion_def("champ_glade_heron", "Glade Heron", WeatherState.RAIN, 8, "ranged", ["Skyborn", "Hunter", "Trickster"], stat="int", playstyle="auto", intent="hybrid", stat_overrides={"resistance": 40}, speed="steady"),
    ...
    _champion_def("champ_snowpelt_cub", "Snowpelt Cub", WeatherState.SNOW, 1, "melee", ["Beast", "Guardian", "Bruiser", "Packmate"], stat="str", durability="tanky_hp", intent="utility", speed="heavy"),
    ...
    _champion_def("champ_eclipse_jaguar", "Eclipse Jaguar", WeatherState.CLOUDY, 7, "ranged", ["Beast", "Channeler", "Stalker"], playstyle="auto", speed="blinding"),
    ...
    _champion_def("champ_thunderhoof_colt", "Thunderhoof Colt", WeatherState.THUNDER, 2, "melee", ["Beast", "Skirmisher", "Packmate"], stat="hybrid", playstyle="auto", intent="hybrid", speed="speedy"),
...
_ENEMY_DEFS: tuple[EnemyDef, ...] = (
    _enemy_def("enemy_conscript", "Conscript", WeatherState.CLEAR, 1, "melee", frozenset({"human"}), stat="int", durability="squishy", playstyle="auto", intent="damage", speed="steady"),
    _enemy_def("enemy_levyman", "Levyman", WeatherState.CLEAR, 1, "melee", frozenset({"human"}), stat="int", durability="tanky_hp", playstyle="auto", intent="utility", speed="heavy"),
    _enemy_def("enemy_picket", "Picket", WeatherState.CLEAR, 1, "melee", frozenset({"human"}), stat="str", durability="squishy", playstyle="auto", intent="damage", speed="brisk"),
    ...
    _enemy_def("enemy_pikeman", "Pikeman", WeatherState.CLEAR, 2, "melee", frozenset({"human"}), stat="str", durability="tanky_arm", playstyle="auto", intent="utility", speed="heavy"),
    _enemy_def("enemy_crossbow_levy", "Crossbow Levy", WeatherState.CLEAR, 2, "ranged", frozenset({"human"}), stat="str", durability="squishy", playstyle="auto", intent="damage", speed="brisk"),
    ...
    _enemy_def("enemy_powder_sapper", "Powder Sapper", WeatherState.CLEAR, 2, "ranged", frozenset({"human"}), stat="str", durability="squishy", playstyle="ability", intent="utility", speed="speedy"),
    _enemy_def("enemy_sergeant_at_arms", "Sergeant-at-Arms", WeatherState.CLEAR, 3, "melee", frozenset({"human"}), durability="tanky_hp", playstyle="auto", intent="damage", speed="heavy"),
    ...
    _enemy_def("enemy_heavy_knight", "Heavy Knight", WeatherState.CLEAR, 4, "melee", frozenset({"human"}), stat="str", durability="tanky_hp", playstyle="auto", intent="utility", speed="leaden"),
    ...
    _enemy_def("enemy_company_guard", "Company Guard", WeatherState.CLEAR, 4, "melee", frozenset({"human"}), stat="int", durability="tanky_hp", playstyle="auto", intent="utility", speed="heavy"),
    _enemy_def("enemy_battlemage", "Battlemage", WeatherState.CLEAR, 5, "ranged", frozenset({"human"}), stat="int", durability="squishy", playstyle="hybrid", intent="damage", speed="steady"),
    ...
    _enemy_def("enemy_steam_knight", "Steam Knight", WeatherState.CLEAR, 6, "melee", frozenset({"human", "machine"}), stat="str", durability="tanky_arm", playstyle="auto", intent="utility", speed="heavy"),
    ...
    _enemy_def("enemy_inquisitor", "Inquisitor", WeatherState.CLEAR, 6, "melee", frozenset({"human"}), durability="tanky_arm", playstyle="auto", speed="steady"),
    ...
    _enemy_def("enemy_lord_commander", "Lord Commander", WeatherState.CLEAR, 7, "melee", frozenset({"human"}), stat="str", durability="tanky_arm", playstyle="auto", intent="utility", speed="steady"),
    _enemy_def("enemy_iron_maiden", "Iron Maiden", WeatherState.CLEAR, 7, "melee", frozenset({"human", "machine"}), durability="tanky_hp", playstyle="ability", speed="leaden"),
    ...
    _enemy_def("enemy_glacier_goliath", "Glacier Goliath", WeatherState.SNOW, 7, "melee", frozenset({"corrupted", "machine"}), stat="str", durability="tanky_arm", playstyle="ability", intent="utility", speed="leaden"),
    _enemy_def("enemy_riven_frost_wyrm", "Riven Frost-Wyrm", WeatherState.SNOW, 9, "melee", frozenset({"corrupted", "beast"}), speed="steady"),
    ...
    _enemy_def("enemy_stormhawk", "Stormhawk", WeatherState.THUNDER, 4, "ranged", frozenset({"corrupted", "beast"}), stat="int", playstyle="hybrid", intent="damage", speed="blinding"),
    _enemy_def("enemy_voltaic_diviner", "Voltaic Diviner", WeatherState.THUNDER, 5, "ranged", frozenset({"corrupted", "spirit"}), stat="int", playstyle="auto", intent="damage", speed="brisk"),
