...
_CHAMPION_DEFS: tuple[ChampionDef, ...] = (
    ...
    _champion_def("champ_veldt_pronghorn", "Veldt Pronghorn", WeatherState.CLEAR, 2, "melee", ["Beast", "Skirmisher"], stat="str", playstyle="auto", intent="damage", speed="brisk"),
    ...
    _champion_def("champ_mirage_caracal", "Mirage Caracal", WeatherState.CLEAR, 8, "melee", ["Beast", "Stalker"], stat="int", durability="squishy", playstyle="ability", intent="damage", speed="blinding"),
    ...
    _champion_def("champ_springfrog", "Springfrog", WeatherState.RAIN, 1, "ranged", ["Tidekin", "Mender"], stat="int", playstyle="ability", intent="utility", speed="steady"),
    ...
    _champion_def("champ_torrent_heron", "Torrent Heron", WeatherState.RAIN, 3, "ranged", ["Skyborn", "Mystic"], stat="str", durability="squishy", playstyle="ability", intent="damage", speed="hybrid"),
    _champion_def("champ_grovekeeper_tapir", "Grovekeeper Tapir", WeatherState.RAIN, 4, "melee", ["Beast", "Bruiser", "Mender"], durability="tanky_hp", speed="leaden"),
    ...
    _champion_def("champ_marsh_thrush", "Marsh Thrush", WeatherState.RAIN, 6, "ranged", ["Skyborn", "Warden"], stat="int", playstyle="ability", intent="utility", speed="brisk"),
    ...
    _champion_def("champ_nerei", "Nerei, the Floodmother", WeatherState.RAIN, 10, "ranged", ["Spirit", "Primordial", "Channeler"], speed="hybrid"),
    ...
    _champion_def("champ_frostquill_porcupine", "Frostquill Porcupine", WeatherState.SNOW, 9, "ranged", ["Beast", "Hunter", "Trickster"], stat="str", playstyle="auto", intent="damage", speed="brisk"),
    _champion_def("champ_borealis", "Borealis, the Pale Aurora", WeatherState.SNOW, 10, "ranged", ["Spirit", "Primordial", "Mystic"], speed="heavy"),
    _champion_def("champ_pebbleback_pangolin", "Pebbleback Pangolin", WeatherState.CLOUDY, 1, "melee", ["Scaled", "Guardian"], stat="str", durability="tanky_hp", intent="utility", speed="leaden"),
    _champion_def("champ_dusk_bat", "Dusk Bat", WeatherState.CLOUDY, 2, "ranged", ["Beast", "Trickster"], stat="int", playstyle="ability", intent="utility", speed="blinding"),
    _champion_def("champ_boulderhide_skink", "Boulderhide Skink", WeatherState.CLOUDY, 3, "ranged", ["Scaled", "Mystic"], stat="str", durability="squishy", playstyle="ability", intent="damage", speed="heavy"),
    ...
    _champion_def("champ_duskstep_marten", "Duskstep Marten", WeatherState.CLOUDY, 5, "melee", ["Beast", "Skirmisher", "Stalker"], stat="int", playstyle="ability", intent="damage", speed="blinding"),
    ...
    _champion_def("champ_eclipse_jaguar", "Eclipse Jaguar", WeatherState.CLOUDY, 7, "ranged", ["Beast", "Stalker", "Channeler"], speed="blinding"),
    ...
    _champion_def("champ_umbra", "Umbra, the Mountain's Shadow", WeatherState.CLOUDY, 10, "ranged", ["Spirit", "Primordial", "Stalker"], speed="steady"),
    ...
    _champion_def("champ_phantom_lynx", "Phantom Lynx", WeatherState.MIST, 3, "melee", ["Spirit", "Stalker"], stat="int", durability="squishy", playstyle="ability", intent="damage", speed="speedy"),
    ...
    _champion_def("champ_wraithorn_stag", "Wraithorn Stag", WeatherState.MIST, 6, "melee", ["Spirit", "Bruiser"], stat="str", playstyle="auto", intent="utility", speed="steady"),
    _champion_def("champ_marshghast_boar", "Marshghast Boar", WeatherState.MIST, 7, "melee", ["Spirit", "Bruiser", "Stalker"], durability="tanky_hp", speed="steady"),
    ...
    _champion_def("champ_mournhollow", "Mournhollow, the Pale Stag", WeatherState.MIST, 10, "ranged", ["Spirit", "Primordial", "Channeler"], speed="hybrid"),
    _champion_def("champ_sparkfly", "Sparkfly", WeatherState.THUNDER, 1, "ranged", ["Swarm", "Trickster"], stat="int", playstyle="ability", intent="utility", speed="blinding"),
    ...
    _champion_def("champ_aerion", "Aerion, the Skybreaker", WeatherState.THUNDER, 10, "ranged", ["Spirit", "Primordial", "Hunter"], speed="brisk"),
)
