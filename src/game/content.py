...
_CHAMPION_DEFS: tuple[ChampionDef, ...] = (
    ...
    _champion_def("champ_aegis_tortoise", "Aegis Tortoise", WeatherState.CLEAR, 5, "str", "melee", "tanky_arm", "hybrid", ["Scaled", "Guardian"]),
    _champion_def("champ_sunmane_lion", "Sunmane Lion", WeatherState.CLEAR, 6, "str", "melee", "standard", "auto", ["Beast", "Bruiser"]),
    _champion_def("champ_goldhide_rhino", "Goldhide Rhino", WeatherState.CLEAR, 7, "hybrid", "melee", "tanky_hp", "hybrid", ["Beast", "Bruiser", "Mender"]),
    _champion_def("champ_mirage_caracal", "Mirage Caracal", WeatherState.CLEAR, 8, "int", "melee", "squishy", "ability", ["Beast", "Stalker"]),
    ...
    _champion_def("champ_reedbank_otter", "Reedbank Otter", WeatherState.RAIN, 2, "str", "melee", "standard", "auto", ["Tidekin", "Skirmisher"]),
    ...
    _champion_def("champ_coral_colossus", "Coral Colossus", WeatherState.RAIN, 5, "str", "melee", "tanky_hp", "hybrid", ["Tidekin", "Guardian", "Mender"]),
    ...
    _champion_def("champ_riptide_caiman", "Riptide Caiman", WeatherState.RAIN, 9, "str", "melee", "squishy", "auto", ["Scaled", "Stalker"]),
    ...
    _champion_def("champ_snowpelt_cub", "Snowpelt Cub", WeatherState.SNOW, 1, "str", "melee", "tanky_hp", "hybrid", ["Beast", "Guardian"]),
    ...
    _champion_def("champ_iceclaw_lynx", "Iceclaw Lynx", WeatherState.SNOW, 6, "int", "melee", "standard", "ability", ["Beast", "Skirmisher", "Trickster"]),
    _champion_def("champ_glacierback_mammoth", "Glacierback Mammoth", WeatherState.SNOW, 7, "hybrid", "melee", "tanky_hp", "hybrid", ["Beast", "Bruiser"]),
    ...
    _champion_def("champ_dusk_bat", "Dusk Bat", WeatherState.CLOUDY, 2, "int", "ranged", "standard", "ability", ["Beast", "Trickster"]),
    ...
    _champion_def("champ_granite_gorilla", "Granite Gorilla", WeatherState.CLOUDY, 6, "int", "melee", "tanky_hp", "ability", ["Beast", "Guardian"]),
    ...
    _champion_def("champ_nightglass_mantis", "Nightglass Mantis", WeatherState.CLOUDY, 8, "int", "melee", "squishy", "ability", ["Swarm", "Stalker"]),
    ...
    _champion_def("champ_will_o_fawn", "Will-o-Fawn", WeatherState.MIST, 2, "int", "ranged", "squishy", "ability", ["Spirit", "Mystic"]),
    _champion_def("champ_phantom_lynx", "Phantom Lynx", WeatherState.MIST, 3, "int", "melee", "squishy", "ability", ["Spirit", "Stalker"]),
    _champion_def("champ_hollow_elk", "Hollow Elk", WeatherState.MIST, 4, "int", "melee", "tanky_hp", "ability", ["Spirit", "Guardian", "Channeler"]),
    ...
    _champion_def("champ_veilfang_wolf", "Veilfang Wolf", WeatherState.MIST, 8, "int", "melee", "standard", "ability", ["Spirit", "Skirmisher"]),
    ...
    _champion_def("champ_thunderhoof_colt", "Thunderhoof Colt", WeatherState.THUNDER, 2, "str", "melee", "standard", "auto", ["Beast", "Skirmisher"]),
    ...
    _champion_def("champ_thunderhide_bison", "Thunderhide Bison", WeatherState.THUNDER, 5, "str", "melee", "tanky_arm", "hybrid", ["Beast", "Guardian"]),
    ...
    _champion_def("champ_storm_eagle", "Storm Eagle", WeatherState.THUNDER, 9, "int", "ranged", "standard", "ability", ["Skyborn", "Hunter", "Channeler"]),
