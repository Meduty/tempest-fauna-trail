...
# Speed axis (T.33b): 7 levels, slow→fast. Faster ⇒ ↑attack_speed/resistance/
# move_speed but ↓primary_stat (softer per-hit) — the established tradeoff, now
# with finer granularity so distinct pieces rarely share an attack_speed. `hybrid`
# is the neutral centre (omitted from role_code). `classify_role` ignores speed.
_SPEED: dict[str, dict[str, float]] = {
    "leaden": {"attack_speed": 0.70, "resistance": 0.70, "primary_stat": 1.25, "move_speed": 0.70},
    "heavy": {"attack_speed": 0.85, "resistance": 0.85, "primary_stat": 1.12, "move_speed": 0.85},
    "steady": {"attack_speed": 0.92, "resistance": 0.92, "primary_stat": 1.06, "move_speed": 0.92},
    "hybrid": {"attack_speed": 1.0, "resistance": 1.0, "primary_stat": 1.0, "move_speed": 1.0},
    "brisk": {"attack_speed": 1.10, "resistance": 1.10, "primary_stat": 0.95, "move_speed": 1.08},
    "speedy": {"attack_speed": 1.2, "resistance": 1.2, "primary_stat": 0.9, "move_speed": 1.15},
    "blinding": {"attack_speed": 1.35, "resistance": 1.30, "primary_stat": 0.82, "move_speed": 1.25},
}
...
_CHAMPION_DEFS: tuple[ChampionDef, ...] = (
    ...
    _champion_def("champ_snowpelt_cub", "Snowpelt Cub", WeatherState.SNOW, 1, "melee", ["Beast", "Guardian"], stat="str", durability="tanky_hp", intent="utility", speed="steady"),
    ...
    _champion_def("champ_glacierback_mammoth", "Glacierback Mammoth", WeatherState.SNOW, 7, "melee", ["Beast", "Bruiser"], durability="tanky_hp", speed="leaden"),
    ...
    _champion_def("champ_dusk_bat", "Dusk Bat", WeatherState.CLOUDY, 2, "ranged", ["Beast", "Trickster"], stat="int", playstyle="ability", intent="utility", speed="brisk"),
    ...
    _champion_def("champ_will_o_fawn", "Will-o-Fawn", WeatherState.MIST, 2, "ranged", ["Spirit", "Mystic"], stat="int", durability="squishy", playstyle="ability", intent="damage", speed="blinding"),
    ...
    _champion_def("champ_thunderhoof_colt", "Thunderhoof Colt", WeatherState.THUNDER, 2, "melee", ["Beast", "Skirmisher"], stat="str", playstyle="auto", intent="damage", speed="brisk"),
    ...
    _champion_def("champ_thunderhide_bison", "Thunderhide Bison", WeatherState.THUNDER, 5, "melee", ["Beast", "Guardian"], stat="str", durability="tanky_arm", intent="utility", speed="steady"),
