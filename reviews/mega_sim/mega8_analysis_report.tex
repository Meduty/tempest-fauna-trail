...
\textit{win\_rate panel --- deviates from cohort win rate at the same power:}\\
{\small
\begin{tabularx}{\linewidth}{rlrL}
\toprule
$P$ & \textbf{piece} (role) & \textbf{wr} & \textbf{why a flier / what it could mean} \\
\midrule
...
2.5 & Veldt Pronghorn T2/L2 (tank) & 0.511 & CH-high --- over-performs the low-$P$ field; cheap kit punches up. \\
3.2 & Hollowed Wisp T3/L2 (assassin) & 0.356 & CH-low --- fragile assassin folds against the same-$P$ cohort before it can burst. \\
...
\textit{wr\_delta panel --- residual after the power curve is removed:}\\
{\small
\begin{tabularx}{\linewidth}{rlrL}
\toprule
$P$ & \textbf{piece} (role) & \textbf{$\Delta$} & \textbf{why a flier / what it could mean} \\
\midrule
...
5.0 & Hierarch T8/L1 (support) & +0.059 & LF --- Hierarch is \emph{over} at L1 but the worst apex \emph{under} at L3: level scaling mis-shaped. \\
5.0 & Caged Banshee T5/L2 (support) & +0.071 & Over --- mid support above budget. \\
8.0 & Borealis T10/L1 (mage) & +0.114 & Over --- king kit already over-budget at L1 (cf. its win\_rate flier above). \\
...
\textit{by role --- residual vs others in the same role:}\\
{\small
\begin{tabularx}{\linewidth}{llrL}
\toprule
\textbf{role} & \textbf{piece} & \textbf{$\Delta$} & \textbf{why a flier / what it could mean} \\
\midrule
...
\textit{by tier --- residual vs others in the same tier:}\\
{\small
\begin{tabularx}{\linewidth}{llrL}
\toprule
\textbf{tier} & \textbf{piece} (role) & \textbf{$\Delta$} & \textbf{why a flier / what it could mean} \\
\midrule
