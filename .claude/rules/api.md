...
> **Before editing:** complete the required reading in [CLAUDE.md](../../CLAUDE.md) → "Required reading before any task work" — SPEC.md, ARCHITECTURE.md (§10 API layer), the task plan doc, the touched design docs, and the touched code.
